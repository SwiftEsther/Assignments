...
import java.net.URL;
    ...
    public class BitcoinRatesActivity extends AppCompatActivity {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            Spinner spinner = (Spinner) findViewById(R.id.bitcoin_card_spinner);
            ...
            Button convert = (Button) findViewById(R.id.bitcoin_convert_button);
            convert.setOnClickListener(new View.OnClickListener()

            {
                @Override
                public void onClick(View view) {
                    TextView textview = (TextView) findViewById(R.id.bitcoin_rate_textView);
                    EditText edittext = (EditText) findViewById(R.id.edit_text);
                    try {
                        URL url = new URL("https://min-api.cryptocompare.com/data/price?fsym=BTC&tsyms=" + val[base]);
